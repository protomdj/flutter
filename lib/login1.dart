...
class _LoginScreen1State  extends State<LoginScreen1> with TickerProviderStateMixin  {
  ...
  final AssetImage backgroundImage = new AssetImage("C:/Users/oi124449/Downloads/logo.jpg");
 ...
 Container(
          ...
          Padding(
            ...
            child: Text(
              "Email",
              style: TextStyle(color: this.primaryColor, fontSize: 16.0, fontWeight: FontWeight.bold),
            ),
          ),
          Container(
            decoration: BoxDecoration(
